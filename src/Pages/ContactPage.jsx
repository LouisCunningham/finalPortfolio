    ...
    <div className="container px-6 py-10 mx-auto">
        <div className="p-5 lg:flex lg:items-center lg:-mx-10 profile-card">
            <div className="lg:w-1/2 lg:mx-10">
                ...
                <p className="mt-4 text-gray-500  roboto-mono-font">
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                ...
                <div className="mt-6 space-y-8 md:mt-8 roboto-mono-font">
                    <p className="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-gray-500 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div className="mt-6 w-80 md:mt-8 flex justify-center align-middle">
                    <h3 className="text-gray-600  ">Follow on:</h3>
