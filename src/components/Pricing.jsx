  ...
  return (
    <div className="  min-h-screen ">
      <div className="container px-6 py-8 mx-auto min-h-full h-100 object-center ">
        ...
        <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
          ...
          >
            <div className="flex flex-col items-center space-y-1">
              ...
              <h2 className="text-lg font-medium text-gray-700 sm:text-xl  roboto-mono-font">Basic</h2>
            </div>
            <div className="flex flex-col items-center space-y-1">
          ...
          >
            <div className="flex flex-col items-center space-y-1">
              ...
              <h2 className="text-lg font-medium text-gray-700 sm:text-xl  roboto-mono-font">Pro</h2>
            </div>
            <div className="flex flex-col items-center space-y-1">
        ...
        {selectedPlan && (
          <div className="p-8 mt-8 space-y-8 bg-gray-100 rounded-xl ease-in-out roboto-mono-font profile-card text--gray-700">
            {selectedPlan === 'Basic' && (
              <>
        ...
        <div className="flex justify-center mt-8">
          <button className="px-8 py-2 tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-600 rounded-md hover:bg-black focus:outline-none focus:bg-black focus:ring focus:ring-black focus:ring-opacity-80 poppins-regular">
            Choose Plan
          </button>
        </div>
      </div>
...
const PlanFeature = ({ feature }) => (
  <div className="flex items-center justify-between text-gray-800 transition duration-500 ease-in-out">
    <p className="text-lg sm:text-xl">{feature}</p>
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-black sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
    </svg>
  </div>
);
